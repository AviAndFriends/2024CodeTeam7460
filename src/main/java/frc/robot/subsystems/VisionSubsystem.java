...
public class VisionSubsystem extends SubsystemBase {
    //It says we gotta match the name of the camera but I'm not sure if this matches "enough"
    ...
    public void periodic() {
        ...
        if(hasTargets){
            ...
            //This is just the best most accurate one on the list (not sure which metric determined that)
            ...
            //these last two are acting up on me so I changed it from .getCorners to .getDetectedCorners 
            ...
            System. out. println(skew);// they said skew was weird 
    ...
    //THIS IS STUFF i COPY AND PASTED FROM GITHUB, THIS STUFF BELONGS IN COMMANDS BECAUSE THATS WHAT THEY ARE
    /* 
    ...
    @Override
    public void teleopPeriodic() { // bad name, change
        double forwardSpeed;
    ...
    @Override
    public void teleopPeriodic() {// bad name
        double forwardSpeed;
        double rotationSpeed;
    ...
    /* This initializes the controller from the copy paste, i think we can delete 
    @Override
